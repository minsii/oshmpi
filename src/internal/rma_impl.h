                                                  ...
                                                  OSHMPI_sobj_attr_t * sobj_attr)
{
    ...
    OSHMPI_sobj_trans_vaddr_to_disp(sobj_attr, (const void *) target_addr, pe, OSHMPI_ABS_DISP,
                                    &target_disp);
                                                  ...
                                                  OSHMPI_sobj_attr_t * sobj_attr)
{
    ...
    /* TODO: check non-int inputs exceeds int limit */
#ifdef OSHMPI_ENABLE_RMA_ABS
    OSHMPI_sobj_trans_vaddr_to_disp(sobj_attr, target_addr, pe, OSHMPI_ABS_DISP, &target_disp);
    OSHMPI_ASSERT(target_disp >= 0);
