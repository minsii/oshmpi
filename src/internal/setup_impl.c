...
static void attach_symm_text(void)
{
    ...
    int symm_flag = 0;
    OSHMPI_sobj_init_attr(&OSHMPI_global.symm_data_attr, SHMEMX_SPACE_HOST, base, size);
...
static void attach_symm_heap(void)
{
    ...
    /* Setup sobj attributes */
    int symm_flag = 0;
    OSHMPI_sobj_init_attr(&OSHMPI_global.symm_heap_attr, SHMEMX_SPACE_HOST, base, size);
